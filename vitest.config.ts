  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/constants.ts': { lines: 97.22, branches: 50 },
        ...
        'src/daemon/Orchestrator.ts': { lines: 78.78, branches: 76.25 },
        'src/daemon/ManagedProcess.ts': { lines: 55.32, branches: 37.1 },
        'src/deploy/env.ts': { lines: 100, branches: 100 },
        'src/deploy/tarball.ts': { lines: 81.53, branches: 78.94 },
        'src/deploy/config.ts': { lines: 66.1, branches: 66.66 },
        'src/deploy/DeployExecutor.ts': { lines: 67.36, branches: 46.98 },
      },
    },
    testTimeout: 15000,
    hookTimeout: 30000,
